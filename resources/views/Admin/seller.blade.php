                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">Daftar Produk</span>
                                <span class="text-muted mt-1 fw-bold fs-7">Produk anda</span>
                            </h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                                            class="text-dark fw-bolder text-hover-primary fs-6">{{ $lp->name }}</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                                            class="text-dark fw-bolder text-hover-primary fs-6">{{ $lp->price }}</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                            ...
                            <div class="overflow-auto pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset('admin/dist/assets') }}/media/avatars/150-2.jpg" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="mb-5 pe-3">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset('admin/dist/assets') }}/media/avatars/150-6.jpg" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
                            ...
                            <div class="pe-3 mb-5">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    ...
                                    <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                        ...
                                        <img src="{{ asset('admin/dist/assets') }}/media/avatars/150-3.jpg" alt="img" />
                                    </div>
                                    <!--end::User-->
                                </div>
                                <!--end::Description-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <form action="{{ route('inputProduk') }}" method="post">
                    {{ csrf_field() }}
                    <label class="form-label fs-6 fw-bolder text-dark">Nama Produk</label>
                    <input class="form-control form-control-solid mb-8" rows="3" type="text" name="name"
                        placeholder="Tuliskan Nama Produkmu">

                    <label class="form-label fs-6 fw-bolder text-dark">Harga</label>
                    <input class="form-control form-control-solid mb-8" rows="3" type="number" name="price"
                        placeholder="Tuliskan Harga">

                    <label class="form-label fs-6 fw-bolder text-dark">Deskripsi</label>
                    <textarea class="form-control form-control-solid mb-8" rows="3" name="description"
                        placeholder="Tuliskan Deskripsi Produk"></textarea>

                    <label class="form-label fs-6 fw-bolder text-dark">Image</label>
                    <input class="form-control form-control-solid mb-8" rows="3" type="file" name="image"
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="{{ asset('admin/dist/assets') }}/media/illustrations/todo.png" alt=""
